...
[Medium](https://medium.com/) and other sites do this
...
This blog was created with [Jekyll](https://jekyllrb.com/) and hosted on [Netlify](https://jekyllrb.com/).
...
To work with the `html` I used [jsdom](https://github.com/jsdom/jsdom), it has a nice dom like API
and I used [jimp](https://github.com/oliver-moran/jimp) to transform the images to `base64`.

For the lazy loading part and switching I decided to use this library called [lazysizes](https://github.com/aFarkas/lazysizes).
