...
<p class="series-box">This post is part of a <a href="/blog/Snake-à-la-functional">series</a> on recreating <code>Snake</code>
in a functional style using <code>JavaScript</code> and a package I wrote.
Find what we achieved in the post code wise <a href="https://github.com/AdamGonda/snake-game/tree/start-modelling">here</a></p>
...
Install [loop](https://github.com/AdamGonda/loop):
...
Because I will use [loop](https://github.com/AdamGonda/loop)
it's given that I model the game in a 2D coordinate system, where
every game object will have an `x` and `y` position.

<div class="post-image"><img class="floating-image" src="/assets/images/2022-06-16/snake-in-2d-grid.jpg" alt="snake-in-2d-grid.jpg" /></div>
...
`view` and `isGameOver` are required by loop's [API](https://github.com/AdamGonda/loop/blob/main/README.md#api).
...
If you checked out [Start here](/blog/Start-here)
