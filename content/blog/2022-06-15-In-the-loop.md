...
in a functional style using <code>JavaScript</code> and a package I wrote.</p>
...
But in our case we will use a package that I wrote a while back called [loop](https://github.com/AdamGonda/loop)
...
For more info about the [API](https://github.com/AdamGonda/loop/blob/main/README.md#api)

Congrats!!! 🥳🥳🥳<br />
You reached the end, nice 👍 Next we [start modeling 👉](/blog/Start-modeling)
